...
export default function ResumeDoc() {
  return (
    <div className="h-full flex flex-col bg-neutral-100 text-gray-900 font-serif">
      <div className="h-12 bg-gray-200 border-b border-gray-300 flex items-center justify-between px-4 shrink-0 select-none">
      ...
      <div className="flex-1 overflow-y-auto p-8 bg-gray-500/10 custom-scrollbar">
        <div className="max-w-[210mm] mx-auto bg-white shadow-xl min-h-[297mm] p-[10mm] md:p-[20mm]">
